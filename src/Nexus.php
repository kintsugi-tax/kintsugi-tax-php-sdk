...
class Nexus
{
     ...
     */
    public function createPhysicalNexusV1NexusPhysicalNexusPost(Components\PhysicalNexusCreate $request, ?Options $options = null): Operations\CreatePhysicalNexusV1NexusPhysicalNexusPostResponse
    {
     ...
     * @throws \KintsugiTax\SDK\Models\Errors\APIException
     */
    public function deletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDelete(string $physicalNexusId, ?Options $options = null): Operations\DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse
    {
     ...
     * @throws \KintsugiTax\SDK\Models\Errors\APIException
     */
    public function getNexusForOrgV1NexusGet(?Operations\GetNexusForOrgV1NexusGetRequest $request = null, ?Options $options = null): Operations\GetNexusForOrgV1NexusGetResponse
    {
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
     ...
     * @throws \KintsugiTax\SDK\Models\Errors\APIException
     */
    public function getPhysicalNexusV1NexusPhysicalNexusGet(?Operations\GetPhysicalNexusV1NexusPhysicalNexusGetRequest $request = null, ?Options $options = null): Operations\GetPhysicalNexusV1NexusPhysicalNexusGetResponse
    {
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/nexus/physical_nexus');
        $urlOverride = null;
     ...
     * @throws \KintsugiTax\SDK\Models\Errors\APIException
     */
    public function updatePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdPut(Components\PhysicalNexusUpdate $physicalNexusUpdate, string $physicalNexusId, ?Options $options = null): Operations\UpdatePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdPutResponse
    {
