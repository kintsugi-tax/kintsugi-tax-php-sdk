...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '0.1.11';

    public string $genVersion = '2.668.4';

    public string $userAgent = 'speakeasy-sdk/php 0.1.11 2.668.4 1.0.0 kintsugi-tax/tax-platform-sdk';
