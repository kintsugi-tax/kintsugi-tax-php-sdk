    ...
    public function getById(string $exemptionId, ?string $xOrganizationId = null, ?Options $options = null): Operations\GetExemptionByIdV1ExemptionsExemptionIdGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\KintsugiTax\SDK\Models\Components\BackendSrcExemptionsSchemasExemptionExemptionRead', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\GetExemptionByIdV1ExemptionsExemptionIdGetResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    backendSrcExemptionsSchemasExemptionExemptionRead: $obj);
