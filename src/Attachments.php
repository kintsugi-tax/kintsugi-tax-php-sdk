...
class Attachments
{
    ...
    public function get(string $exemptionId, ?Options $options = null): Operations\GetAttachmentsForExemptionV1ExemptionsExemptionIdAttachmentsGetResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_attachments_for_exemption_v1_exemptions__exemption_id__attachments_get', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, 'array<\KintsugiTax\SDK\Models\Components\AttachmentRead>', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
