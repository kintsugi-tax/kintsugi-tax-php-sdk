...
class Filings
{
     ...
     */
    public function getFilingByIdV1FilingsFilingIdGet(string $filingId, ?Options $options = null): Operations\GetFilingByIdV1FilingsFilingIdGetResponse
    {
     ...
     * @throws \KintsugiTax\SDK\Models\Errors\APIException
     */
    public function getFilingsByRegistrationIdV1FilingsRegistrationRegistrationIdGet(string $registrationId, ?int $page = null, ?int $size = null, ?Options $options = null): Operations\GetFilingsByRegistrationIdV1FilingsRegistrationRegistrationIdGetResponse
    {
     ...
     * @throws \KintsugiTax\SDK\Models\Errors\APIException
     */
    public function getFilingsV1FilingsGet(?Operations\GetFilingsV1FilingsGetRequest $request = null, ?Options $options = null): Operations\GetFilingsV1FilingsGetResponse
    {
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
