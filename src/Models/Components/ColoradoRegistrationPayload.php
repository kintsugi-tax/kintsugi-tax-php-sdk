...
class ColoradoRegistrationPayload
{
    /**
     *
    ...
    /**
     * Whether this Colorado registration is declared obligated to file a Retail Delivery Fee return (DR 1786).
     *
