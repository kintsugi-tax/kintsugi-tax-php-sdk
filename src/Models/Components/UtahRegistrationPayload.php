...
class UtahRegistrationPayload
{
     ...
     *
     * @var \KintsugiTax\SDK\Models\Components\UtahFields $jurisdictionSpecificFields
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('jurisdiction_specific_fields')]
    #[\Speakeasy\Serializer\Annotation\Type('\KintsugiTax\SDK\Models\Components\UtahFields')]
    ...
    /**
     * 6-digit Sales Tax PIN from the Utah sales tax license or mailed separately. Encrypted into pin_encrypted on save.
     *
     * @var ?string $pinPlainText
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('pin_plain_text')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?string $pinPlainText = null;
     ...
     * @param  \KintsugiTax\SDK\Models\Components\UtahFields  $jurisdictionSpecificFields
