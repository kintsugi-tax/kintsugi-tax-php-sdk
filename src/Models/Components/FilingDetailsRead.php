...
class FilingDetailsRead
{
    ...
    /**
     * Input VAT recovery rate applied to this filing, as a percentage 0-100. Null when no rate exists for the filing's country and year, which means fully recoverable. Uses the definitive rate when set, otherwise the year's frozen provisional.
     *
    ...
    /**
     * True when input_vat_recovery_rate is this year's definitive rate. False when it is the provisional. Null when no rate exists.
     *
     * @var ?bool $inputVatRecoveryRateIsDefinitive
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('input_vat_recovery_rate_is_definitive')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?bool $inputVatRecoveryRateIsDefinitive = null;
    ...
    /**
     * Whether amount_fees is a penalty, interest, or other fee. Null when unknown (legacy rows).
     *
     * @var ?\KintsugiTax\SDK\Models\Components\FeeTypeEnum $feeType
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('fee_type')]
    #[\Speakeasy\Serializer\Annotation\Type('\KintsugiTax\SDK\Models\Components\FeeTypeEnum|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?FeeTypeEnum $feeType = null;
     ...
     *
     * @var ?string $submittedReturnConfirmationId
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('submitted_return_confirmation_id')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?string $submittedReturnConfirmationId = null;

    /**
     * Payment confirmation ID captured when the filing was moved to Submitted
     *
     * @var ?string $submittedPaymentConfirmationId
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('submitted_payment_confirmation_id')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?string $submittedPaymentConfirmationId = null;
     ...
     * @param  ?bool  $inputVatRecoveryRateIsDefinitive
     ...
     * @param  ?\KintsugiTax\SDK\Models\Components\FeeTypeEnum  $feeType
     ...
     * @param  ?string  $submittedReturnConfirmationId
     * @param  ?string  $submittedPaymentConfirmationId
