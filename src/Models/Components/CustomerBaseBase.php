...
class CustomerBaseBase
{
     ...
     * @var ?bool $isTestData
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('is_test_data')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?bool $isTestData = null;
